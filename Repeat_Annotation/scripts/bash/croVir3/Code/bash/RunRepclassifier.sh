...
species_prefix="croVir3_"

# NOTE: Change this each time you run the script
# Set the RepeatModeler directory
repeat_modeler_dir="$HOME/Documents/Kaas/SquamateAlignments/SoftMasking/$family/$genus/$species_name/croVir3/Results/0_RepeatModeler"

# NOTE: Change this each time you run the script
# Set the repclassifier directory for output
repclassifier_dir="$HOME/Documents/Kaas/SquamateAlignments/SoftMasking/$family/$genus/$species_name/croVir3/Results/1_Repclassifier"

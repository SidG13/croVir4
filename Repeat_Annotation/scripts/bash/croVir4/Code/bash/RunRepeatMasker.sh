...
species_abbreviation="croVir4"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/Documents/Kaas/SquamateAlignments/Data/Reference_Genomes/CastoeGenomes/Crotalus/Crotalus_viridis_viridis/Assembly/croVir4_genome_2025-10-05_v1.fasta"
